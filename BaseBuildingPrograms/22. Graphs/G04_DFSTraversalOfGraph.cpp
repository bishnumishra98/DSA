...
//    i.  Mark the current node as visited in the 'vis' array, so that it is not get traversed again in future; and push the
...
//      where E = no.of edges in graph, 2 * E = total degrees of graph, i.e., sum of number of neighbours of all nodes
//      Overall, T.C: O(n + E)
