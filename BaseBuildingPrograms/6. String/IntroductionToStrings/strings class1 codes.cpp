...
int main() {
  ...
  // string desc = "HelloWorld";
  // desc.erase(3, 2);
  // cout << desc << endl;   // HelWorld
  ...
  // cout << "Printing name:  " << name << endl;   // Printing name:  Love kumar Babbar
  ...
  // string str2 = "star";
  // string str3  = "staryyyy";

  // cout << str1.find(str2) << endl;   // 16
 
  // if(str1.find(str3) == string::npos){
  //  //not found
  //  cout << "Not FOund" << endl;   // "Not Found" gets printed
  // }
  // else {
  //  cout << "Found" << endl;
  // }
