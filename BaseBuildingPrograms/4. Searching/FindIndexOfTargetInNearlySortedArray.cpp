// If an element at 'ith' index in a sorted array is present at '(i-1)th', 'ith', or
// '(i+1th)' index in another array, then the another array is called "nearly sorted array".
